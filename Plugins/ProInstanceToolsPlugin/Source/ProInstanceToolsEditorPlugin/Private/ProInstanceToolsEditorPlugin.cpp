...
void FProInstanceToolsEditorPluginModule::StartupModule()
{
	...
	int Priority = 42;
	FPlacementCategoryInfo ProInstanceTools( LOCTEXT("ProInstanceTools", "ProInstance Tools"), FSlateIcon("ProInstanceToolsStyle", "ProInstance.CategoryIcon"), "ProInstanceTools", TEXT("PMProInstanceTools"), Priority);
	...
	StyleSet->Set("ProInstance.CategoryIcon", new FSlateImageBrush(ProInstanceIconPath + TEXT("ProInstanceToolsEditorIcon16.png"), FVector2D(16.f, 16.f)));
